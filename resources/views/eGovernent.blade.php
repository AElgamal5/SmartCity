                            ...
                            <div class="u-layout-row" style="">
                                <div class="u-container-style u-layout-cell u-size-60 u-layout-cell-1">
                                    <div class="u-container-layout u-container-layout-1">
                                        ...
                                        <h6 class="u-align-center u-text u-text-default u-text-2" {{-- style="margin-right: 0% " --}}>
                                        ...
                                        <a href="{{ Route('citizen.idCard') }}" data-page-id="668810255"
                                            style="margin-left:45%"
                                            class="u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-palette-2-base u-radius-20 u-btn-2">
                                            View</a>
                                        <div style="margin: -10% 75% 0 5%;">
                                            <form action="{{ Route('citizen.certficateOfBirth') }}" method="POST"
                                                ...
                                                <div class="u-form-group u-form-select u-form-group-1">
                                                    ...
                                                    <div class="u-form-select-wrapper">
                                                        <select id="select-deb0" name="cid" required
                                                            class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                                                            @if (!empty($cares) and Auth::guard('citizen')->check())
                                                                <option value="">Select</option>
                                                                <option value="{{ Auth::guard('citizen')->user()->id }}">
                                                                    Me</option>
                                                                @foreach ($cares as $care)
                                                                    <option value="{{ $care->cid }}">
                                                                        {{ $care->fname }}</option>
                                                                @endforeach
                                                            @elseif (empty($cares) and Auth::guard('citizen')->check())
                                                                <option value="">select</option>
                                                                <option value="{{ Auth::guard('citizen')->user()->id }}">
                                                                    Me</option>
                                                            @else
                                                ...
                                                <div class="u-align-right u-form-group u-form-submit">
                                                    ...
                                                    <button type="submit"
                                                        class="u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-radius-20 u-btn-4">VIEW</button>
                                                </div>
