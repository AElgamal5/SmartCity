    ...
    <section class="u-clearfix u-section-1" id="sec-8646">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-expanded-width-xs u-form u-form-1">
                <form action="{{ route('citizen.login.save') }}" method="POST"
                    name="form-1" class="u-clearfix u-form-spacing-10 u-inner-form"
                    style="padding: 10px;">
                    @csrf
                    <div class="u-form-group u-form-name">
                        <label for="name-48d8" class="u-label">Social Security number</label>
                        <input type="number" placeholder="Enter your SSN" id="name-48d8" name="id"
                            class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required autofocus>
                    </div>
                    <div class="u-form-email u-form-group">
                        <label for="email-48d8" class="u-label">Password</label>
