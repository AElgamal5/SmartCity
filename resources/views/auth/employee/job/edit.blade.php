...
@section('content')
    ...
    <section class="u-clearfix u-section-1" id="sec-6175">
        <div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"></span>
            <h3 class="u-text u-text-default u-text-1"><b><u>Edit Job</u></b>
            </h3>
            <div class="u-expanded-width-xs u-form u-form-1">
                <form action="{{ Route('employee.editJob.save', $job[0]->jid) }}" method="POST"
                    ...
                    <div class="u-form-group u-form-select u-form-group-7">
                        ...
                        <div class="u-form-select-wrapper">
                            <select id="select-b7c6" name="confirm"
                                ...
                                <option value="1" {{ $job[0]->confirm == '1' ? 'selected' : '' }}>Confirmed</option>
                                <option value="0" {{ $job[0]->confirm == '0' ? 'selected' : '' }}>Unconfirmed</option>
                            </select>
                    ...
                    <div class="u-form-group u-form-select u-form-group-7">
                        ...
                        <div class="u-form-select-wrapper">
                            <select id="select-b7c6" name="status"
                                ...
                                <option value="0" {{ $job[0]->status == '0' ? 'selected' : '' }}>Idle</option>
                                <option value="1" {{ $job[0]->status == '1' ? 'selected' : '' }}>Active</option>
                            </select>
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" version="1"
                                class="u-caret">
                                <path fill="currentColor" d="M4 8L0 4h8z"></path>
