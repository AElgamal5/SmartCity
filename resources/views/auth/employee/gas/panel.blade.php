...
@section('title', 'Facility of Gas')

@section('content')

    <section class="u-clearfix u-section-1" id="sec-8305">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h3 class="u-text u-text-default u-text-1"><b><u>Gas Reader</u></b></h3>
            <a href="{{ Route('employee.gasAdd') }}" data-page-id="184833867"
                    ...
                    <tbody class="u-custom-color-1 u-table-body u-table-body-1">
                        @foreach ($readers as $reader)
                            <tr style="height: 59px;">
                                ...
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-11">
                                    <a href="{{ Route('employee.editGas', $reader->reader_id) }}">Edit</a>/<a
                                        href="{{ Route('employee.deleteGas', $reader->reader_id) }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <section class="u-clearfix u-section-1" id="sec-8305">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h3 class="u-text u-text-default u-text-1"><b><u>Gas log history</u></b></h3>
