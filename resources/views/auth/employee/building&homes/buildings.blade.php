                        ...
                        @foreach ($buildings as $building)
                            <tr style="height: 59px;">
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $building->building_id }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $building->no_floors }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $building->no_flats }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $building->lid }}
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $building->sb_type }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $building->area }}
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                ...
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $building->created_at }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $building->updated_at }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-12">
                                    <a
                                        href="{{ Route('employee.editBuilding', $building->building_id) }}">Edit</a>{{-- /<a
                ...
                <table class="u-table-entity">
                    ...
                    <tbody class="u-custom-color-1 u-table-body u-table-body-1">
                        ...
                        @foreach ($homes as $home)
                            <tr style="height: 59px;">
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $home->home_id }}
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $home->bid }}
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7"> {{ $home->area }} M
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $home->floor_no }}
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $home->rooms_no }}
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    {{ $home->home_rent }} EGP</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">
                                    @if ($home->status == 1)
                                        Active
                                    @else
                                ...
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-12">
                                    <a
                                        href="{{ Route('employee.editHome', $home->home_id) }}">Edit</a>{{-- /
