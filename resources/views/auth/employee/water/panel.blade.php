...
@section('title', 'Facility of Water')

@section('content')

    <section class="u-clearfix u-section-1" id="sec-8305">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h3 class="u-text u-text-default u-text-1"><b><u>Water Reader</u></b></h3>
                    ...
                    <tbody class="u-custom-color-1 u-table-body u-table-body-1">
                        @foreach ($readers as $reader)
                            <tr style="height: 59px;">
                                ...
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-11">
                                    <a href="{{ Route('employee.editWater', $reader->reader_id) }}">Edit</a>/<a
                                        href="{{ Route('employee.deleteWater', $reader->reader_id) }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <section class="u-clearfix u-section-1" id="sec-8305">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h3 class="u-text u-text-default u-text-1"><b><u>Water log history</u></b></h3>
            {{-- <a href="{{ Route('employee.waterAdd') }}" data-page-id="184833867"
                class="u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-palette-2-light-1 u-radius-50 u-btn-1">ADD
                Water log</a> --}}
            <div class="u-table u-table-responsive u-table-1">
                ...
                <col width="16.7%">
                    ...
                    <tbody class="u-custom-color-1 u-table-body u-table-body-1">
                        @foreach ($logs as $log)
                            <tr style="height: 59px;">
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $log->log_id }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-8">{{ $log->reader_id }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-9">{{ $log->last_read }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-9">{{ $log->current_read }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-10">{{ $log->created_at }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-11">{{ $log->updated_at }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
