...
<section class="u-clearfix u-section-1" id="sec-edd9">
    <div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"><img src="{{ asset('images/1684070.png') }}" alt=""></span>
      ...
      <p class="u-text u-text-default u-text-3">201802012</p>
      ...
      <p class="u-text u-text-7">Smouha</p>
      <p class="u-text u-text-8">115</p>
      <p class="u-text u-text-9">2</p>
      <p class="u-text u-text-10">5</p>
      <p class="u-text u-text-11">110</p><span class="u-file-icon u-icon u-icon-3"><img src="{{ asset('images/125768.png') }}" alt=""></span>
      ...
      <div class="u-form u-form-1">
        <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom" name="form" style="padding: 10px;">
          ...
          <div class="u-align-center u-form-group u-form-submit">
            <a href="#" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-radius-21 u-btn-1">Submit</a>
      ...
      </div><span class="u-file-icon u-icon u-icon-4"><img src="{{ asset('images/opened-door-aperture-png-icon-101378.png') }}" alt=""></span>
      ...
      <div class="u-form u-form-2">
        <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom" name="form" style="padding: 10px;">
          ...
          <div class="u-align-center u-form-group u-form-submit">
            <a href="#" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-radius-21 u-btn-2">Submit</a>
            <input type="submit" value="submit" class="u-form-control-hidden">
          </div>
          <div class="u-form-send-message u-form-send-success"> Thank you! Your message has been sent. </div>
          <div class="u-form-send-error u-form-send-message"> Unable to send your message. Please fix errors then try again. </div>
  ...
  <section class="u-clearfix u-section-2" id="sec-b477">
    <div class="u-clearfix u-sheet u-sheet-1">
      <p class="u-text u-text-1">
        ...
        <br>Total Amount In EGP:<br>
        <br>
      </p><span class="u-file-icon u-icon u-icon-1"><img src="{{ asset('images/702461.png') }}" alt=""></span><span class="u-file-icon u-icon u-icon-2"><img src="{{ asset('images/252851.png') }}" alt=""></span>
      ...
      <p class="u-text u-text-default u-text-3">1</p>
      <p class="u-text u-text-default u-text-4">2</p>
      <p class="u-text u-text-default u-text-5">3</p>
      <p class="u-text u-text-default u-text-6">4</p>
      <p class="u-text u-text-default u-text-7">5%</p>
      <p class="u-text u-text-default u-text-8">5%</p>
      <p class="u-text u-text-default u-text-9"style="margin-top: 1% ">5</p>
      <p class="u-text u-text-default u-text-10">6</p><span class="u-file-icon u-icon u-icon-3"><img src="{{ asset('images/3835.png') }}" alt=""></span>
      <div class="u-table u-table-responsive u-table-1">
        <table class="u-table-entity">
          <colgroup>
            <col width="13.3%">
      ...
      <p class="u-text u-text-default u-text-11" style="margin-top: -27% ">7</p>
      <p class="u-text u-text-default u-text-12">8</p>
      <p class="u-text u-text-default u-text-13">5%</p>
      <p class="u-text u-text-default u-text-14"style="margin-top: 2% ">9</p>
    </div>
  </section>
    {{-- <section class="u-clearfix u-section-1" id="sec-edd9">
        <div class="u-clearfix u-sheet u-sheet-1">
