...
@section('content')
    ...
    <section class="u-clearfix u-section-1" id="sec-d350">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h3 class="u-text u-text-default u-text-1">Contact Us</h3>
            <a href="{{ Route('about') }}" data-page-id="2938000539"
                class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-custom-color-1 u-btn-1">[
                About<span style="font-size: 0.875rem;"> ]</span>
            </a>
            <div class="u-align-left u-border-3 u-border-grey-40 u-container-style u-expanded-width-xs u-group u-group-1">
                <div class="u-container-layout u-container-layout-1">
                    <p class="u-text u-text-2">
                        <span class="u-text-custom-color-1">
                            <span style="font-size: 1.125rem; font-weight: 700;">Our Contact Channels</span>
                            <br>
                            <br>
                        </span>We aim to reach you anytime &amp; everywhere.. Your satisfaction is our mission.For any
